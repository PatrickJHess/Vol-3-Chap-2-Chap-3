...
* Understanding the difference between quoted and transaction prices for coupon bonds.  
* Applying the **datetime module** for date manipulation.  
* Calculating accrued interest for a dataset of 304 bonds.  
* Exporting the finalized DataFrame of 304 bonds to an Excel workbook format.
